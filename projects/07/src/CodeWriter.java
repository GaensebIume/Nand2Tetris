...
public class CodeWriter {
    ...
    private void setUpDict() {
        ...
        dictionary.put("static","16");//1st static index; possibly unnecessary, to be tested
    ...
    public void writePushPop(COMMANDTYPE commandtype, String segment, int index){
        ...
        if(commandtype == COMMANDTYPE.C_PUSH){
            ...
            switch (segment) {
                ...
                case "constant" -> throw new IllegalArgumentException("cannot pop a constant");
            }
